...
public abstract class AbstractHttpServer extends HttpServlet {
	...
	protected void service(HttpServletRequest req, HttpServletResponse resp) {
		try{
			...
			Log.get(this.getClass(),"handle").error(e);
			try {
	...
	protected abstract void handle(String act,HttpInfo info, HttpServletRequest req, HttpServletResponse resp) throws Exception; ;
