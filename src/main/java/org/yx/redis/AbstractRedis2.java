...
public abstract class AbstractRedis2 implements Redis, Redis2, Cloneable {

	protected final Jedis2Executor jedis2Executor;
	private boolean mute;
	private transient AbstractRedis2 muteConnectionExceptionRedis;

	public AbstractRedis2(Jedis2Executor executor) {
	...
	@Override
	public Redis mute() {
		AbstractRedis2 r = this.muteConnectionExceptionRedis;
		if (r != null) {
			return r;
		}
		if (this.mute) {
